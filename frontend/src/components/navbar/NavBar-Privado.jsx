...
import { cerrarSesionaction } from "../../redux/slice/Autenticacion";
            ...
            <div className="flex h-16 justify-start items-center">
              <div className="flex justify-center flex-row w-full">
                ...
                <div className="hidden md:ml-6 md:flex md:space-x-8">
                  ...
                  >
                    Organizador finanzas
                  </Link>
                </div>
                <div className="hidden md:ml-6 md:flex md:space-x-8">
                  <Link
                    to="/Agregar-Transaccion"
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <button
                    ...
                    type="button"
                    className="relative m-9 inline-flex items-center gap-x-1.5 rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600"
                  >
                    <IoLogOutOutline className="h-5 w-4" aria-hidden="true" />

...
import { ActualizarUsuarioApi } from "../../services/users/userServices";
...
const Perfil = () => {
  ...
  return (
    <>
      <div className="max-w-4xl md:mx-auto lg:mx-auto mx-10  my-10 p-8 bg-white rounded-lg shadow-md ">
        ...
        {isPending && <MensajeAlerta type="loading" message='actualizando...' />} 
            ...
            {isSuccess && (<MensajeAlerta type='success' message={'Actualizacion exitosa'} />)} 
